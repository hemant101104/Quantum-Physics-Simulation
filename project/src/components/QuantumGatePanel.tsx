...
import { quantumGates } from '../utils/quantumGates';

interface QuantumGatePanelProps {
  onApplyGate: (gate: QuantumGate) => void;
  onMeasure: () => void;
  onReset: () => void;
}

export const QuantumGatePanel: React.FC<QuantumGatePanelProps> = ({
  onApplyGate,
  onMeasure,
  onReset
}) => {
