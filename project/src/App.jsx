...
import { useQuantumSimulation } from './hooks/useQuantumSimulation.js';
import { WaveFunctionVisualizer } from './components/WaveFunctionVisualizer.jsx';
import { QuantumStateDisplay } from './components/QuantumStateDisplay.jsx';
import { QuantumGatePanel } from './components/QuantumGatePanel.jsx';
import { TunnelingSimulation } from './components/TunnelingSimulation.jsx';
import { SimulationControls } from './components/SimulationControls.jsx';

function App() {
  const [activeTab, setActiveTab] = useState('states');
  const [tunnelingParams, setTunnelingParams] = useState({
    width: 600,
    height: 300,
    barrierHeight: 5.0,
    barrierWidth: 50,
        ...
        {activeTab === 'states' && (
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-slate-800/50 border border-slate-700 rounded-lg p-6">
                <h2 classNgitame="text-xl font-semibold text-white mb-4">Probability Distribution</h2>
                <WaveFunctionVisualizer
                  waveFunction={waveFunction}
                  width={500}
                  height={200}
      ...
      <footer className="bg-slate-800/50 backdrop-blur-sm border-t border-slate-700 mt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="text-center text-slate-400 text-sm">
            <p>Quantum Physics Simulation • Built with React, JavaScript & Advanced Mathematics</p>
